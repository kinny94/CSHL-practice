...
class ms_processors(ms_errors):
    ...
    __swig_getmethods__["getAffinityForCpu"] = lambda x: _msparser.ms_processors_getAffinityForCpu
    if _newclass:getAffinityForCpu = staticmethod(_msparser.ms_processors_getAffinityForCpu)
    __swig_getmethods__["setAffinityForCpu"] = lambda x: _msparser.ms_processors_setAffinityForCpu
    if _newclass:setAffinityForCpu = staticmethod(_msparser.ms_processors_setAffinityForCpu)
ms_processors_swigregister = _msparser.ms_processors_swigregister
ms_processors_swigregister(ms_processors)

def ms_processors_getAffinityForCpu(*args):
  return _msparser.ms_processors_getAffinityForCpu(*args)
ms_processors_getAffinityForCpu = _msparser.ms_processors_getAffinityForCpu

def ms_processors_setAffinityForCpu(*args):
  return _msparser.ms_processors_setAffinityForCpu(*args)
ms_processors_setAffinityForCpu = _msparser.ms_processors_setAffinityForCpu
